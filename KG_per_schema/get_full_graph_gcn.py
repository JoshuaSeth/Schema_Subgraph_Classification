...
edges_as_indices_tensor = torch.tensor(edges_as_indices, dtype=torch.long)
...
x = conv1(x, edges_as_indices_tensor)  # pass tensor instead of np array
x = conv1(x, edges_as_indices_tensor)  # pass tensor instead of np array
...
with open('scierc_init_embeddings.pkl', 'wb') as f:
