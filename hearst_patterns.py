...
Modified from: https://github.com/kinivi/patent_ner_linking/blob/main/project.ipynb'''
import pandas as pd
...
class Hearst_Patterns:
    ...
    def __init__(self, patterns_file="patterns.json", text_path="G06K.txt"):
        ...
        self.en_nlp = spacy.load("en_core_sci_scibert")
...
hp = Hearst_Patterns(patterns_file="hearst_patterns.json",
                     text_path="ORKG_parsers/dygiepp/texts/tom_hope_future_research_or_challenge.txt")
hp.extract_patterns(size=50, start=5896, save_folder="extracted_patterns")
